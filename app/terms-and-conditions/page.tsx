        ...
        <>
            <section id="banner" className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-30 my-10 pt-20">
                ...
                >
                    ...
                    <p className="text-white w-[70%] text-center">We are committed to maintaining the highest standards of transparency & trust. This page provides clear guidance on how we operate, what to expect from us and the responsibilities that come with partnering with us as a customer or supplier</p>
                </div>
            </section>
