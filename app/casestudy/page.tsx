...
import { casestudies } from "@/types/casestudy.type";
    ...
    >
      <div className="flex flex-col items-center gap-2 pt-20 pb-10">
        ...
        <p className="text-[#333333] px-10 text-center w-full md:w-[90%] xl:w-[70%]">
          Explore our portfolio of transformative design projects that have helped brands stand out and achieve exceptional results.
        </p>
      </div>
